...
st.set_page_config(page_title="Big Dog Consolidation", page_icon="💰")

st.title("Big Dog Consolidations")

ticker=st.text_input('Ticker','PLTR,UPS')
ticker=ticker.split(",")

number = st.number_input("Insert a number of candles", value=25, placeholder="Type a number...")
